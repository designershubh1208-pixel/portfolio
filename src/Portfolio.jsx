...
const PROJECTS = [
  { num: "01", title: "User Panel Dashboard", desc: "A sleek, responsive admin dashboard built with React and modular UI components for user management.", tags: ["React", "Dashboard", "UI/UX"], url: "https://github.com/shubhsanket/user-panel-dashboard" },
  { num: "02", title: "ProvenDev", desc: "Developer reputation and credential platform leveraging on-chain verification for trust.", tags: ["Web3", "Solidity", "Next.js"], url: "https://github.com/shubhsanket/ProvenDev" },
  { num: "03", title: "On-Block", desc: "Decentralized content publishing system built on Polygon with IPFS storage integration.", tags: ["Polygon", "IPFS", "Blockchain"], url: "https://github.com/shubhsanket/on-block" },
  { num: "04", title: "TinyLlama QLoRA Chat", desc: "Real-time inference engine using fine-tuned TinyLlama with QLoRA quantization for edge deployment.", tags: ["PyTorch", "LLM", "QLoRA"], url: "https://github.com/shubhsanket/tinyllama-qlora-realtime-chat" },
  { num: "05", title: "CLM-DealSign", desc: "Contract lifecycle management system with digital signing, AI clause analysis, and audit trails.", tags: ["AI", "Node.js", "Contracts"], url: "https://github.com/shubhsanket/CLM-DealSign" },
];
...
const FULL_TEXT = "Building the future from the protocol layer to the pixel. Engineering intelligent, decentralized systems with a human-centric design approach.";
...
// ── PROJECT CARD ──
function ProjectCard({ num, title, desc, tags, url, delay }) {
  const [ref, visible] = useReveal();
    ...
    <>
      ...
      <section id="about">
        ...
        <div className="about-content">
          ...
          <Reveal delay={0.2}>
            <p className="about-body">I am Shubhsanket Sharma, currently studying in 2nd year B.Tech CSE at Durgapur Institute of Advanced Technology and Management. I focus on building scalable web systems, intelligent AI applications, and decentralized architectures that bridge strong engineering principles with thoughtful user experience.</p>
          </Reveal>
          <Reveal delay={0.3}>
      ...
      {/* ══ PROJECTS ══ */}
      <section id="projects">
        <Reveal><div className="section-eyebrow">Selected Work</div></Reveal>
      ...
      {/* ══ CONTACT ══ */}
      <section id="contact">
        <Reveal><div className="section-eyebrow">Get In Touch</div></Reveal>
